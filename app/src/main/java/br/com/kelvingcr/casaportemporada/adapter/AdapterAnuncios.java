package br.com.kelvingcr.casaportemporada.adapter;
...
public class AdapterAnuncios extends RecyclerView.Adapter<AdapterAnuncios.MyViewHolder> {
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView text_titulo, text_descricao, text_data;

        public MyViewHolder(@NonNull View itemView) {
            super(itemView);

            img_anuncio = itemView.findViewById(R.id.img_anuncio);
            text_titulo = itemView.findViewById(R.id.textTitulo);
            text_descricao = itemView.findViewById(R.id.textDescricao);
